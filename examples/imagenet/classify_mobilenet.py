...
def classify(model_data_path, image_paths):
    '''Classify the given images using mobilenet.'''

    # Get the data specifications for the mobilenet model
    spec = models.get_data_spec(model_class=models.MOBILENET)
    ...
    net = models.MOBILENET({'data': input_node})
...
def main():
    ...
    parser.add_argument('model_path', help='Converted parameters for the mobilenet model')
